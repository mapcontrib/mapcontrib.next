                    ...
                    <OrangeTheme>
                        ...
                        >
                            <Toolbar.Group>
                                ...
                                <Toolbar.Item icon="map" onClick={() => onClickMapBackgrounds()} />
                                <Toolbar.Item icon="list" onClick={() => onClickCustomTags()} />
                                <Toolbar.Item icon="list-alt" onClick={() => onClickPresets()} />
                                <Toolbar.Item icon="commenting" onClick={() => onClickTranslations()} />
                            </Toolbar.Group>
                        </Toolbar.Collapse>
                    </OrangeTheme>
                </StyledToolbar>
